...
- **Nombre completo:DARWIN PATRICIO GANAN LUGMANA**
- **Cédula:1723554604**
- **NRC:30405**
- **Código del examen:** `AGSK-2026`
- **Fecha y hora de inicio:**      2026-07-30 22:15
...
|:---:|-----------|-----------------|-----------------------|
| — | `NN` | los 2 últimos dígitos de mi cédula | 04                    |
| 1 | Nombre de la tabla | `tbl_productos_base_` + `NN` | tbl_productos_base_04 |
| 2 | Puerto | `81` + `NN` | 8104                  |
...
- **Enlace al video (5 min, cámara + pantalla):** https://youtu.be/A5tFstr8Lks
...
**Firma (nombre completo):** DARWIN PATRICIO GANAN LUGMAÑA
